...
const instruments = [
    { name: "01", type: "AG-GR", sound: "Sound/Ejemplos/01.mp3" },
    { name: "02", type: "AG-GR", sound: "Sound/Ejemplos/02.mp3" },
    { name: "03", type: "GR-AG", sound: "Sound/Ejemplos/03.mp3" },
    { name: "04", type: "GR-AG", sound: "Sound/Ejemplos/04.mp3" },
    { name: "05", type: "GR-AG", sound: "Sound/Ejemplos/05.mp3" },
    { name: "06", type: "AG-GR", sound: "Sound/Ejemplos/06.mp3" },
    { name: "07", type: "AG-GR", sound: "Sound/Ejemplos/07.mp3" },
    { name: "08", type: "IGU", sound: "Sound/Ejemplos/08.mp3" },
    { name: "09", type: "GR-AG", sound: "Sound/Ejemplos/09.mp3" },
    { name: "10", type: "AG-GR", sound: "Sound/Ejemplos/10.mp3" },
    { name: "11", type: "AG-GR", sound: "Sound/Ejemplos/11.mp3" },
    { name: "12", type: "AG-GR", sound: "Sound/Ejemplos/12.mp3" },
    { name: "13", type: "GR-AG", sound: "Sound/Ejemplos/13.mp3" },
    { name: "14", type: "AG-GR", sound: "Sound/Ejemplos/14.mp3" },
    { name: "15", type: "IGU", sound: "Sound/Ejemplos/15.mp3" },
    { name: "16", type: "GR-AG", sound: "Sound/Ejemplos/16.mp3" },
    { name: "17", type: "IGU", sound: "Sound/Ejemplos/17.mp3" },
    { name: "18", type: "GR-AG", sound: "Sound/Ejemplos/18.mp3" },
    { name: "19", type: "GR-AG", sound: "Sound/Ejemplos/19.mp3" },
    { name: "20", type: "AG-GR", sound: "Sound/Ejemplos/20.mp3" },
    { name: "21", type: "IGU", sound: "Sound/Ejemplos/21.mp3" },
    { name: "22", type: "AG-GR", sound: "Sound/Ejemplos/22.mp3" },
    { name: "23", type: "IGU", sound: "Sound/Ejemplos/23.mp3" },
    { name: "24", type: "GR-AG", sound: "Sound/Ejemplos/24.mp3" },
    { name: "25", type: "GR-AG", sound: "Sound/Ejemplos/25.mp3" },
    { name: "26", type: "GR-AG", sound: "Sound/Ejemplos/26.mp3" },
    { name: "27", type: "AG-GR", sound: "Sound/Ejemplos/27.mp3" },
    { name: "28", type: "AG-GR", sound: "Sound/Ejemplos/28.mp3" },
    { name: "29", type: "AG-GR", sound: "Sound/Ejemplos/29.mp3" },
    { name: "30", type: "AG-GR", sound: "Sound/Ejemplos/30.mp3" }
...
document.getElementById("AG-GR-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("AG-GR");
});

document.getElementById("GR-AG-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("GR-AG");
});

document.getElementById("IGU-button").addEventListener("click", function() {
    if (!clicksEnabled) return;
    checkAnswer("IGU");
});
